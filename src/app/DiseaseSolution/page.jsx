    ...
    <>
      ...
      <div className=" flex flex-wrap gap-3 px-3 justify-center">
        ...
        {filteredSymptoms.map((symptom, index) => (
          <div
            key={index}
            className=" p-2 rounded-md  flex-row justify-center items-center m-2 w-full sm:w-4/12 md:w-2/12   bg-green-200 text-midnight font-bold ">
