    ...
    <div className='bg-green-100 mt-8 py-6 rounded-lg shadow-lg'>
      <div className='max-w-5xl mx-auto px-6'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-9'>
          <div className='flex ring-4 ring-green-400 flex-col items-center justify-center bg-white rounded-lg p-4 text-center'>
          ...
          <div className='flex  ring-4 ring-green-400 flex-col items-center justify-center bg-white rounded-lg p-4 text-center'>
            <h3 className='text-3xl font-bold'><CountUp duration={3} end={9400} />+</h3>
