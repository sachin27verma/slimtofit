...
export const Services = () => {
  return (
    <div>
      ...
      <div className=' py-7 bg-cover flex  align-middle  bg-center' style={{ backgroundImage: "url('./h6.jpg')" }}>
        <div className=' w-5/6 mx-auto flex justify-center gap-[100px] '>
        ...
        <div className="flex  justify-center items-center p-6 bg-[#f0fdf4]">
          <div className="flex items-center ">
            ...
            <img
              ...
              src="/path/to/your/image.jpg" // Replace this with the correct image source
              style={{
                aspectRatio: "1/1",
                objectFit: "cover",
              }}
